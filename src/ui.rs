...
pub fn draw_ui(
    ...
    ui.window("VERSO K1 - AI Coding Assistant")
        ...
        .build(|| {
            ...
            if ui.button("Remember Current Project") {
            ...
            if ui.button("Record: Opened Rust File") {
                learner.record_action("open_rust_file", "coding_session");
            }
            ...
            if ui.button("Test Transformer") {
                ...
                ui.text(format!("Output shape: {:?}", out.shape()));
            }
            ...
            if let Some(suggestion) = learner.suggest_next("coding_session") {
                ...
                ui.text_disabled("Not enough data yet...");
            }
        });
}
